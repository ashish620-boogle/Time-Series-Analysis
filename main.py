...
def main():
    ...
    print("Minute model (last 100 preds):")
    print(f"  MAE: {result['minute_mae']}")
    print(f"  MSE: {result['minute_mse']}")
    print(f"  RMSE: {result['minute_rmse']}")
    print(f"  R2: {result['minute_r2']}")
    print("Hour model (last 100 preds):")
    print(f"  MAE: {result['hour_mae']}")
    print(f"  MSE: {result['hour_mse']}")
    print(f"  RMSE: {result['hour_rmse']}")
    print(f"  R2: {result['hour_r2']}")
